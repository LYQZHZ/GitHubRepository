...
public class SwingUiRootMain extends JFrame implements ActionListener{
...
//		ActionListener jb1Listener = new Listener() ;
		...
		jb5.setBounds(300, 720, 500, 50);
		jb6.setBounds(750, 800, 500, 50);
